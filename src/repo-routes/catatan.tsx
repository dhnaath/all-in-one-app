...
export const Route = createFileRoute("/catatan")({
  head: () => ({
    meta: [
      { title: "Catatan & Knowledge Base — Client OS Konsultan" },
      {
        name: "description",
        content:
          "Basis pengetahuan konsultan: notulen rapat, temuan lapangan, metodologi, checklist, dan template kerja praktik.",
      },
      { property: "og:title", content: "Catatan & Knowledge Base Konsultan" },
      {
        property: "og:description",
        content:
          "Dokumentasikan notulen rapat, SOP, temuan lapangan, dan metodologi praktik konsultansi manajemen.",
      },
    ],
  }),
